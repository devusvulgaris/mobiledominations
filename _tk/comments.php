...
<ul class="tabs-menu clearfix">
        <li class="current"><a href="#tab-1">Комментарии VK </a><span class="fb-comments-count" data-href="<?php the_permalink(); ?> "></span></li>
        <li><a href="#tab-2">Комментарии сайта</a></li>
</ul>
 <div class="tab">
...
<script type="text/javascript">
  VK.init({apiId: 5055220, onlyWidgets: true});
</script>
